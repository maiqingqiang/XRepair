...
// +----------------------------------------------------------------------
namespace app\xrepair\model;

use app\admin\model\RouteModel;
use think\Model;
use tree\Tree;

class RepairRegionModel extends Model
{
    ...
    public function adminCategoryTableTree($currentIds = 0, $tpl = '')
    {
        ...
        foreach ($categories as $key => $value) {
            ...
            $categories[$key]['str_action'] = '<a href="' . url("Region/add", ["parent" => $value['id']]) . '">添加下级区域</a> | <a href="' . url("Region/edit", ["id" => $value['id']]) . '">' . lang('EDIT') . '</a> | <a class="js-ajax-delete" href="' . url("Region/delete", ["id" => $value['id']]) . '">' . lang('DELETE') . '</a> ';
        }
