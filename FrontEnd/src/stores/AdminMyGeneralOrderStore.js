...
class AdminMyGeneralOrderStore {
    ...
    onRefresh() {
        ...
        let _this = this;
        axios.post('/XRepair/BackEnd/public/service/admin/getMyGeneralOrder', qs.stringify({page: this.repairListPage})).then((res) => {
            let data = res.data;
            if (data.code == 200) {
    ...
    getRepair(post=[]) {
        ...
        let _this = this;
        axios.post('/XRepair/BackEnd/public/service/admin/getMyGeneralOrder', qs.stringify(data)).then((res) => {
...
const adminMyGeneralOrderStore = new AdminMyGeneralOrderStore();

export default adminMyGeneralOrderStore;

export {AdminMyGeneralOrderStore}