(function () {
  ...
  function _f(e, n, t) {
    ...
    var i = t(0),
        ...
        d = t(65),
        p = t.n(d);
    p.a.defaults.headers.post["Content-Type"] = "application/x-www-form-urlencoded", r.a.Component.prototype.axios = p.a;
    var b = "localhost" === _$1.window.location.host ? "/XRepair/BackEnd/webapp/app/index" : "";
  ...
  function _g(e, n, t) {
    ...
    function i() {
      if ("serviceWorker" in navigator) {
        if (new URL("/XRepair/BackEnd/public/app", _$1.window.location).origin !== _$1.window.location.origin) return;

        _$1.window.addEventListener("load", function () {
          var e = "/XRepair/BackEnd/public/app/service-worker.js";
          a ? o(e) : r(e);
        });
      }
    }
